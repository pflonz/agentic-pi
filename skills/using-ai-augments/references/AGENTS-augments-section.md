# AGENTS.md: AI Augments Skills Section

Copy and paste the following section into your project's `AGENTS.md` file. This configures the default entrypoint to declare that this project follows a skill-driven workflow under the AI Augments skill set.
...
When this section is present in `AGENTS.md`, the agent MUST, at the start of every user request:
...
After adding this section to `AGENTS.md`, verify it contains both required markers:
- `## AI Augments Skills` ✓
